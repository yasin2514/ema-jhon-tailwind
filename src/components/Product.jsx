...
const Product = ({ product ,handleClick}) => {
    ...
    return (
        <div className='border border-gray-300 rounded-lg flex flex-col overflow-hidden'>
            ...
            <button onClick={() => handleClick(product)} className='text-center mt-auto bg-[#FF9900] p-3 rounded-br rounded-bl'>Add to Cart <ShoppingCartIcon className='w-6 inline-block' ></ShoppingCartIcon></button>
        </div>
    );
};
